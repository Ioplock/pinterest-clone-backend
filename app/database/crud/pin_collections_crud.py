...
class CRUDPinCollection:
    ...
    # async def add_pin_to_collection(self, db: AsyncSession, pin_id: int, collection_id: int): # FIXME: this method is not working anymore
    ...
    # async def remove_pin_from_collection(self, db: AsyncSession, pin_id: int, collection_id: int): # FIXME: this method is not working anymore
